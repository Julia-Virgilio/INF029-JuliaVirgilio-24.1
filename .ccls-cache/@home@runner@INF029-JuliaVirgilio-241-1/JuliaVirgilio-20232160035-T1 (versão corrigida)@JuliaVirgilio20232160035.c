...
DiasMesesAnos q2(char datainicial[], char datafinal[])
{
    ...
    if (q1(datainicial) == 0){
      ...
      if(data_i.iAno % 4 == 0 || data_i.iAno % 400 == 0) data_i_b = 1;
      if(data_f.iAno % 4 == 0 || data_f.iAno % 400 == 0) data_f_b = 1;

      if(data_i.iAno == data_f.iAno){

        if(data_i.iMes - data_f.iMes == 1 || data_f.iMes - data_i.iMes == 1){
          if(data_i.iMes == 2 && data_i_b == 1){
            dma.qtdDias = 29 - data_i.iDia + data_f.iDia;
            if(dma.qtdDias >= 29){
          ...
          if(data_i.iMes == 2 && data_i_b == 0){
            dma.qtdDias = 28 - data_i.iDia + data_f.iDia;
              if(dma.qtdDias >= 28){
          ...
          if(data_i.iMes == 4 || data_i.iMes == 6 || data_i.iMes == 9 || data_i.iMes == 11){
            dma.qtdDias = 30 - data_i.iDia + data_f.iDia;
              if(dma.qtdDias >= 30){
              ...
              dma.qtdDias = 31 - data_i.iDia + data_f.iDia;
                if(dma.qtdDias >= 31){
      ...
      if(data_i.iAno != data_f.iAno){
        ...
        if(data_i.iMes - data_f.iMes == 1 || data_f.iMes - data_i.iMes == 1){
          ...
          if(data_i.iMes == 2 || data_f.iMes == 2){
            if(data_i_b == 1 && data_f_b == 0){
              dma.qtdDias = 29 - data_i.iDia + data_f.iDia - 1;
                if(dma.qtdDias >= 29){
                  dma.qtdDias = dma.qtdDias - 29;
                  dma.qtdMeses = 1;
                  dma.qtdAnos = data_f.iAno - data_i.iAno;
            ...
            if(data_f_b == 1 && data_i_b == 0){
              dma.qtdDias = 28 - data_i.iDia + data_f.iDia + 1;
              if(dma.qtdDias >= 28){
                dma.qtdDias = dma.qtdDias - 28;
                dma.qtdMeses = 1;
                dma.qtdAnos = data_f.iAno - data_i.iAno;
